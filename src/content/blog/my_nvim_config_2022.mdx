...
import telescope from '../../images/tele.gif'
import tree from '../../images/nvimtree.gif'
import float from '../../images/floatterm.gif'
...
<Image src={telescope} alt="Telescope gif animation" />
...
<Image src={tree} alt="Nvim tree gif animation" />
...
<Image src={float} alt="Float term animation" />
